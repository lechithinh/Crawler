...
def CrawlDataPaper(name_author, url_search):
    lst_link = getLinkPaper(url_search)
...
def PaperCrawl(name_author, numberOfpage):
    ...
    for i in range(0, numberOfpage):
        ...
        if respone.status_code == 200:
            CrawlDataPaper(name_author, url_search=url_search)
